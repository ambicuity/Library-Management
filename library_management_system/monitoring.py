...
class PerformanceMetrics:
    ...
    def record_request(
        self, duration_ms: float, operation: str, success: bool = True
    ) -> None:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        for operation, metrics in self.operation_metrics.items():
            stats["operations"][operation] = {
                ...
                "error_rate_percent": (metrics["errors"] / max(metrics["count"], 1))
                * 100,
            }
...
class SecurityMonitor:
    ...
    def check_rate_limit(
        ...
        self.rate_limit_tracking[identifier] = [
            request_time
            for request_time in self.rate_limit_tracking[identifier]
    ...
    def get_security_summary(self) -> Dict[str, Any]:
        ...
        recent_activities = [
            activity
            for activity in self.suspicious_activities
            if datetime.fromisoformat(activity["timestamp"])
        ...
        return {
            ...
            "recent_suspicious_activities": recent_activities[
                -10:
            ],  # Last 10 activities
        }
...
class MonitoringSystem:
    ...
    def __init__(
        ...
        self.security_monitor = (
            SecurityMonitor() if enable_security_monitoring else None
        )
    ...
    def record_system_event(
        self, event: str, description: str, level: LogLevel = LogLevel.INFO, **kwargs
    ) -> None:
    ...
    def check_health(self) -> Dict[str, Any]:
        ...
        if self.performance_metrics:
            ...
            if stats["error_rate_percent"] > self.error_rate_threshold:
                ...
                self._trigger_alert(
                    "high_error_rate", {"error_rate": stats["error_rate_percent"]}
                )
            ...
            for entry in log_entries:
                ...
                if entry["event_type"] == "user_action" and entry.get("user_id"):
                    ...
                    user_actions[user_id][action] = (
                        user_actions[user_id].get(action, 0) + 1
                    )
...
def monitor_performance(
    operation_name: str, monitoring_system: Optional[MonitoringSystem] = None
):
