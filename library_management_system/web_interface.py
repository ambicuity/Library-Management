...
class ThemeManager:
    ...
    def get_available_themes(self) -> List[Dict[str, str]]:
        ...
        """
        return [
            {"key": key, "name": theme["name"]} for key, theme in self.themes.items()
        ]
...
class WebInterface:
    ...
    def __init__(
        ...
        # Update search index
        self.enhanced_search.update_index(
            self.library.display_books(), self.library.display_members()
        )
        ...
        async def dashboard(request: Request):
            ...
            recent_activities = [
                ...
                },
                {
                    ...
                    "description": "New member 'Jane Smith' added",
                },
                {
                    "timestamp": "2024-01-14 16:45",
                    "description": "Book 'Data Science' returned by Alice Johnson",
                },
            ]
